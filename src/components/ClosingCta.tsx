...
export function ClosingCta() {
  return (
    <section className="border-b border-[var(--paper-line-strong)] bg-[var(--orange)] py-14">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 px-5 text-center sm:flex-row sm:justify-between sm:text-left sm:px-8">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-sm border-2 border-[var(--paper-raised)] bg-[var(--paper-raised)] px-5 py-2.5 font-spec text-[13px] font-semibold uppercase tracking-[0.05em] text-[var(--orange-ink)]"
          >
            <Phone size={16} />
            Call Now
          </a>
